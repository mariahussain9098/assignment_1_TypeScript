...
console.log("Q : 2");
var maria = "Hello Maria, would you like to learn some Python today?";
console.log(maria);
...
console.log("Q : 5");
var famous_person = "Maulana Rumi";
var message = "The wound is the place where the light enters you.";
console.log(message);
...
console.log("Q : 11");
var friendsName = ["Saba", "Aliza", "Asma"];
...
console.log("Q : 13");
var cars = ["Toyota Camry", "Toyota Corolla", "Honda Accord", "BMW 3 Series"];
for (var _i = 0, cars_1 = cars; _i < cars_1.length; _i++) {
    var car_1 = cars_1[_i];
    console.log("I would like to own a ".concat(car_1, "."));
}
//14.  Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
console.log("Q : 14");
var guestList = ["Saba", "Aliza", "Yasmeen"];
console.log("Dear ".concat(guestList[0], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
console.log("Dear ".concat(guestList[1], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
console.log("Dear ".concat(guestList[2], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
...
console.log("Dear ".concat(guestList[0], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
console.log("Dear ".concat(guestList[2], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
console.log("Dear ".concat(guestList[4], ": \t You are cordially invited to join me for dinner. Your presence would be an honor for me."));
...
var removeGeusts = guestList.pop();
// console.log(removeGeusts);
console.log("Dear ".concat(removeGeusts, " I am sorry, we can't invite you for dinner due to some unexpected  issue"));
...
console.log("Dear ".concat(guestList[0], ", you are still invited for dinner"));
console.log("Dear ".concat(guestList[1], ", you are still invited for dinner"));
...
console.log("Q : 18");
var placesToVisit = ["Mecca", "Medina", "Al-AqsaMosque", "Istanbul", "Granada"];
...
for (var _a = 0, cities_1 = cities; _a < cities_1.length; _a++) {
    ...
    console.log("my favourite city is : ".concat(city, "."));
}
...
for (var _b = 0, cities_obj_1 = cities_obj; _b < cities_obj_1.length; _b++) {
    var city = cities_obj_1[_b];
    console.log("City: ".concat(city.name, ", Population: ").concat(city.population, ", Country: ").concat(city.country));
}
...
console.log("Q : 30");
var usernames = ['admin', 'ali', 'asad', 'ahmed', 'saad'];
...
var current_users = ['farah', 'nida', 'dania', 'sara', 'maryam'];
// List of new usernames
var new_users = ['sara', 'nida', 'mahnoor', 'fatima', 'ayesha'];
var _loop_1 = function (newUser) {
    // Check if the username is already used (case-insensitive)
    var isUsernameUsed = current_users.some(function (username) { return username.toLowerCase() === newUser.toLowerCase(); });
    if (isUsernameUsed) {
        console.log("Sorry, the username '".concat(newUser, "' is already taken. Please enter a new username."));
    }
    else {
        console.log("Great! The username '".concat(newUser, "' is available."));
    }
};
...
for (var _e = 0, numbers_1 = numbers; _e < numbers_1.length; _e++) {
    var number = numbers_1[_e];
...
for (var _f = 0, pizzas_1 = pizzas; _f < pizzas_1.length; _f++) {
    var pizzaName = pizzas_1[_f];
    console.log(pizzaName);
}
for (var _g = 0, pizzas_2 = pizzas; _g < pizzas_2.length; _g++) {
    var pizzaName = pizzas_2[_g];
...
console.log("Q : 35");
var animals = ["elephant", "dolphin", "kangaroo"];
...
makeShirt(); // Large shirt with the default message
makeShirt('Medium'); // Medium shirt with the default message
makeShirt('Small', 'Hello World!'); // Small shirt with a custom message
...
console.log("Q : 41");
var magicians = ['Mystique Mirage', 'Merlin Moonlight', 'Celestia Enigma'];
...
var originalMagicians = ['Mystique Mirage', 'Merlin Moonlight', 'Celestia Enigma'];
// Call make_great to modify the copy of the array
var greatMagicians = __spreadArray([], originalMagicians, true); // Creating a copy
// Reuse the make_great function from Exercise 42 to modify the array
